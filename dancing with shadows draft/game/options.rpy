...
define config.name = _("Dancing With Shadows Prologue")
...
define build.name = "dancingwithshadowsprologue"
...
define config.save_directory = "dancingwithshadowsdraft-1737858163"
